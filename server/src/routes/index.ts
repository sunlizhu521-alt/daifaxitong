...
apiRouter.use("/products", requireAnyPage(["productLibrary", "dropShippingRegistration", "returnRegistration", "shippingSchedule", "purchaseOrders", "dropshipSummary"]), productsRouter);
apiRouter.use("/suppliers", requireAnyPage(["suppliers", "dropShippingRegistration", "shippingSchedule", "purchaseOrders", "dropshipSummary", "returnRegistration"]), suppliersRouter);
...
apiRouter.use("/stores", requireAnyPage(["storeLibrary", "returnRegistration", "dropshipSummary", "purchaseOrders"]), storesRouter);
