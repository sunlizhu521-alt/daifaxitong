...
apiRouter.use("/products", requireAnyPage(["productLibrary", "dropShippingRegistration", "accessoryRegistration", "trackingNumbers", "returnRegistration", "shippingSchedule", "purchaseOrders", "dropshipSummary"]), productsRouter);
apiRouter.use("/suppliers", requireAnyPage(["suppliers", "dropShippingRegistration", "accessoryRegistration", "trackingNumbers", "shippingSchedule", "purchaseOrders", "dropshipSummary", "returnRegistration"]), suppliersRouter);
apiRouter.use("/orders", requireAnyPage(["dropShippingRegistration", "accessoryRegistration", "trackingNumbers", "shippingSchedule", "purchaseOrders", "dropshipSummary", "returnRegistration"]), ordersRouter);
