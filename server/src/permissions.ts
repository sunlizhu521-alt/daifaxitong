...
export const pageOptions = [
  ...
  { key: "repairRegistration", label: "维修换货登记", path: "/repair-registration" },
  { key: "repairFeedback", label: "维修换货反馈", path: "/repair-feedback" },
  { key: "repairRecord", label: "维修换货记录", path: "/repair-record" },
